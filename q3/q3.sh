...
echo -e "\nAlphabetically:" >> $Q3_HOME/output/q3.txt
sort $Q3_HOME/output/all_results.txt >> $Q3_HOME/output/sorted_results.txt
echo -e "\n2. 5th to last term with its word count" >> $Q3_HOME/output/q3.txt

tail -n 5 $Q3_HOME/output/sorted_results.txt | head -n 1 >> $Q3_HOME/output/q3.txt
echo -e "\n3. 1st term with its word count" >> $Q3_HOME/output/q3.txt

head -n 1 $Q3_HOME/output/sorted_results.txt >> $Q3_HOME/output/q3.txt
cat $Q3_HOME/output/sorted_results.txt | sort -k2,2nr > $Q3_HOME/output/sorted_results_by_number.txt
echo -e "\nNumerically:" >> $Q3_HOME/output/q3.txt
echo -e "\n2. 5th to last term with its word count" >> $Q3_HOME/output/q3.txt

tail -n 5 $Q3_HOME/output/sorted_results_by_number.txt | head -n 1 >> $Q3_HOME/output/q3.txt

echo -e "\n3. 1st term with its word count" >> $Q3_HOME/output/q3.txt
head -n 1 $Q3_HOME/output/sorted_results_by_number.txt >> $Q3_HOME/output/q3.txt 
